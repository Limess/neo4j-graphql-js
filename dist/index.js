...
function cypherMutation(_ref7, context, resolveInfo) {
  ...
  var params = (0, _utils.isCreateMutation)(resolveInfo) && !mutationTypeCypherDirective ? (0, _extends3.default)({ params: otherParams }, { first: first, offset: offset }) : (0, _extends3.default)({}, otherParams, { first: first, offset: offset });
