...
exports.computeOrderBy = exports.relationDirective = exports.cypherDirective = exports.isAddMutation = exports.isCreateMutation = undefined;
...
function innerFilterParams(filters) {
  return (0, _keys2.default)(filters).length > 0 ? '{' + (0, _entries2.default)(filters).filter(function (_ref4) {
    ...
    return key + ':$' + (typeof value.index === 'undefined' ? key : value.index + '-' + key);
  }).join(',') + '}' : '';
}
...
var computeOrderBy = exports.computeOrderBy = function computeOrderBy(resolveInfo, selection) {
  var orderByVar = _argumentValue(resolveInfo.operation.selectionSet.selections[0], 'orderBy', resolveInfo.variableValues);
